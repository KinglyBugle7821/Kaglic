...
public class CoalGeneratorMenu extends AbstractContainerMenu {
    ...
    public CoalGeneratorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData){
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(CoalGeneratorBlockEntity.SLOT_SIZE));
    }
    ...
    public CoalGeneratorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        checkContainerSize(inv, CoalGeneratorBlockEntity.SLOT_SIZE);
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = CoalGeneratorBlockEntity.SLOT_SIZE;  // must be the number of slots you have!
    @Override
